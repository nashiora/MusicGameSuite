...
namespace FxMania.Game
{
    public sealed class HighwayControl
    {
        ...
        private float m_addRoll, m_addOffset;
        ...
        public void ApplyToView(HighwayView view)
        {
            ...
            view.TargetBaseRoll = m_addRoll;
            view.TargetOffset = m_addOffset;
        }
        ...
        public void Update()
        {
            ...
            {
                case Damping.Fast: LerpTo(ref m_combinedLaserOutput, m_targetCombinedLaserOutput, 0.50f, 25); break;
            ...
            if (m_spin != null)
            {
                ...
                {
                    float time = (float)((Time.Total - m_spin.StartTime) / m_spin.Params.Duration) * 2f;
            ...
            m_addRoll = spinRoll + swingRoll;
            m_addOffset = wobbleOffset;
