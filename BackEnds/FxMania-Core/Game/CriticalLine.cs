...
namespace FxMania.Game
{
    public sealed class CriticalLine : Panel
    {
        ...
        public float AddRoll { get => m_addRoll; set { m_addRoll = value; m_isDirty = true; } }
        public float AddOffset { get => m_addOffset; set { m_addOffset = value; m_isDirty = true; } }
        ...
        private void UpdateOrientation()
        {
            ...
            Rotation = -LaserRoll - MathL.Sin(AddRoll * MathL.Pi_f * 2) * 10;

            float critDist = CriticalHeight - HorizonHeight;
            float desiredCritWidth = Window.Width * 0.75f;

            m_container.Position = new Vector2(-LaserRoll * 10 + AddOffset * 100, critDist);
